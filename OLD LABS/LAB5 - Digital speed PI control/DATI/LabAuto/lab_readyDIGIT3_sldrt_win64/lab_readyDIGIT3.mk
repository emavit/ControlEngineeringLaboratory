...
MODEL                := lab_readyDIGIT3
MODULES              := lab_readyDIGIT3_data.c lab_readyDIGIT3_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := lab_readyDIGIT3.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lab_readyDIGIT3_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/LabAuto;Z:/windows_profile/Desktop/LabAuto/lab_readyDIGIT3_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
