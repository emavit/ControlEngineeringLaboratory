...
%{
____________________PUNTO 8-10____________________________
%}
k = 40;
Cth=k*(s + 3)*(s + 1)/(s*(s + 10));
...
%{
____________________PUNTO 11___________________________
%}
Cx=-(s+0.5)/s;
%figure;
rlocus(Gx*Cx);
...
%{
____________________PUNTO 12___________________________
%}
Cx = -(s + 0.5)^2/(s*(s + 10));
%figure;
rlocus(Gx*Cx);
...
%{
____________________PUNTO 13___________________________
%}
x = [0, 0, pi/6, 0];