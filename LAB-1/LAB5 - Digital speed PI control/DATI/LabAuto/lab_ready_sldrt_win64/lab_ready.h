...
#ifndef RTW_HEADER_lab_ready_h_
#define RTW_HEADER_lab_ready_h_
#include <string.h>
#ifndef lab_ready_COMMON_INCLUDES_
#define lab_ready_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab_ready_COMMON_INCLUDES_ */

#include "lab_ready_types.h"
...
#define lab_ready_rtModel              RT_MODEL_lab_ready_T

/* Block signals (default storage) */
typedef struct {
  real_T Output;                       /* '<S3>/Output' */
  real_T pulse2degATTENZIONE1;         /* '<Root>/pulse2deg - ATTENZIONE1' */
  real_T MultiportSwitch;              /* '<Root>/Multiport Switch' */
  real_T pulse2degATTENZIONE;          /* '<Root>/pulse2deg - ATTENZIONE' */
  real_T Delay;                        /* '<S5>/Delay' */
  real_T degs2rpm;                     /* '<S5>/degs2rpm' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Saturation;                   /* '<S1>/Saturation' */
  real_T Add;                          /* '<Root>/Add' */
  real_T IGain1;                       /* '<S1>/I Gain1' */
  real_T Output_p;                     /* '<S2>/Output' */
  uint8_T FixPtSwitch;                 /* '<S8>/FixPt Switch' */
  uint8_T FixPtSwitch_p;               /* '<S11>/FixPt Switch' */
...
typedef struct {
  ...
  uint8_T Output_DSTATE_b;             /* '<S12>/Output' */
  uint8_T Output_DSTATE_l;             /* '<S6>/Output' */
} DW_lab_ready_T;
...
#define rtB                            lab_ready_B
#define BlockIO                        B_lab_ready_T
#define rtX                            lab_ready_X
#define ContinuousStates               X_lab_ready_T
#define rtXdot                         lab_ready_XDot
#define StateDerivatives               XDot_lab_ready_T
#define tXdis                          lab_ready_XDis
#define StateDisabled                  XDis_lab_ready_T
#define rtP                            lab_ready_P
#define Parameters                     P_lab_ready_T
#define rtDWork                        lab_ready_DW
#define D_Work                         DW_lab_ready_T

/* Parameters (default storage) */
struct P_lab_ready_T_ {
  ...
  real_T RepeatingSequenceStair1_OutValues[2];
                             ...
                             */
  real_T Staircase_OutValues[11];      /* Mask Parameter: Staircase_OutValues
                                        * Referenced by: '<S4>/Vector'
                                        */
  real_T RepeatingSequenceStair_OutValues[2];
  ...
  uint8_T LimitedCounter_uplimit;      /* Mask Parameter: LimitedCounter_uplimit
                                        ...
                                        */
  uint8_T LimitedCounter_uplimit_n;  /* Mask Parameter: LimitedCounter_uplimit_n
                                      * Referenced by: '<S11>/FixPt Switch'
                                      */
  uint8_T LimitedCounter_uplimit_c;  /* Mask Parameter: LimitedCounter_uplimit_c
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T pulse2degATTENZIONE1_Gain;    /* Expression: -1
                                        * Referenced by: '<Root>/pulse2deg - ATTENZIONE1'
                                        */
  real_T Constant_Value_n;             /* Expression: 2
                                        * Referenced by: '<S5>/Constant'
                                        */
  real_T pulse2degATTENZIONE_Gain;     /* Expression: 0.18
  ...
  real_T Delay_InitialCondition;       /* Expression: 0
                                        ...
                                        */
  real_T PGain_Gain;                   /* Expression: 0.056
  ...
  real_T Saturation_LowerSat;          /* Expression: -12
                                        * Referenced by: '<S1>/Saturation'
                                        */
  real_T IGain1_Gain;                  /* Expression: 8.72
...
extern P_lab_ready_T lab_ready_P;

/* Block signals (default storage) */
extern B_lab_ready_T lab_ready_B;

/* Continuous states (default storage) */
extern X_lab_ready_T lab_ready_X;

/* Block states (default storage) */
extern DW_lab_ready_T lab_ready_DW;

/* Model entry point functions */
extern void lab_ready_initialize(void);
extern void lab_ready_output(void);
extern void lab_ready_update(void);
extern void lab_ready_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab_ready_rtModel *lab_ready(void);
...
extern RT_MODEL_lab_ready_T *const lab_ready_M;
 ...
 *
 * '<Root>' : 'lab_ready'
 * '<S1>'   : 'lab_ready/Controllore'
 * '<S2>'   : 'lab_ready/Repeating Sequence Stair'
 * '<S3>'   : 'lab_ready/Repeating Sequence Stair1'
 * '<S4>'   : 'lab_ready/Staircase'
 * '<S5>'   : 'lab_ready/Subsystem'
 * '<S6>'   : 'lab_ready/Repeating Sequence Stair/LimitedCounter'
 * '<S7>'   : 'lab_ready/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S8>'   : 'lab_ready/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 * '<S9>'   : 'lab_ready/Repeating Sequence Stair1/LimitedCounter'
 * '<S10>'  : 'lab_ready/Repeating Sequence Stair1/LimitedCounter/Increment Real World'
 * '<S11>'  : 'lab_ready/Repeating Sequence Stair1/LimitedCounter/Wrap To Zero'
 * '<S12>'  : 'lab_ready/Staircase/LimitedCounter'
 * '<S13>'  : 'lab_ready/Staircase/LimitedCounter/Increment Real World'
 * '<S14>'  : 'lab_ready/Staircase/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_lab_ready_h_ */
