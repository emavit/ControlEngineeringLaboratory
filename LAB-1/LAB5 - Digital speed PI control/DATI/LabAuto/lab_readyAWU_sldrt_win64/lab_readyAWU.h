...
#ifndef RTW_HEADER_lab_readyAWU_h_
#define RTW_HEADER_lab_readyAWU_h_
#include <string.h>
#ifndef lab_readyAWU_COMMON_INCLUDES_
#define lab_readyAWU_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab_readyAWU_COMMON_INCLUDES_ */

#include "lab_readyAWU_types.h"
...
#define lab_readyAWU_rtModel           RT_MODEL_lab_readyAWU_T
...
#define rtB                            lab_readyAWU_B
#define BlockIO                        B_lab_readyAWU_T
#define rtX                            lab_readyAWU_X
#define ContinuousStates               X_lab_readyAWU_T
#define rtXdot                         lab_readyAWU_XDot
#define StateDerivatives               XDot_lab_readyAWU_T
#define tXdis                          lab_readyAWU_XDis
#define StateDisabled                  XDis_lab_readyAWU_T
#define rtP                            lab_readyAWU_P
#define Parameters                     P_lab_readyAWU_T
#define rtDWork                        lab_readyAWU_DW
#define D_Work                         DW_lab_readyAWU_T

/* Parameters (default storage) */
struct P_lab_readyAWU_T_ {
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S2>/Saturation'
                                        */
  real_T AWUgain_Gain;                 /* Expression: 0
...
extern P_lab_readyAWU_T lab_readyAWU_P;

/* Block signals (default storage) */
extern B_lab_readyAWU_T lab_readyAWU_B;

/* Continuous states (default storage) */
extern X_lab_readyAWU_T lab_readyAWU_X;

/* Block states (default storage) */
extern DW_lab_readyAWU_T lab_readyAWU_DW;

/* Model entry point functions */
extern void lab_readyAWU_initialize(void);
extern void lab_readyAWU_output(void);
extern void lab_readyAWU_update(void);
extern void lab_readyAWU_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab_readyAWU_rtModel *lab_readyAWU(void);
...
extern RT_MODEL_lab_readyAWU_T *const lab_readyAWU_M;
 ...
 * '<Root>' : 'lab_readyAWU'
 * '<S1>'   : 'lab_readyAWU/3'
 * '<S2>'   : 'lab_readyAWU/Speed Controller AWU'
 * '<S3>'   : 'lab_readyAWU/Speed Filter'
 * '<S4>'   : 'lab_readyAWU/3/LimitedCounter'
 * '<S5>'   : 'lab_readyAWU/3/LimitedCounter/Increment Real World'
 * '<S6>'   : 'lab_readyAWU/3/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_lab_readyAWU_h_ */
