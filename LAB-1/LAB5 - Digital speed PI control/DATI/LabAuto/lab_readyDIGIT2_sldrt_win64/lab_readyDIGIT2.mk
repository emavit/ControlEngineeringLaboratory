...
MODEL                := lab_readyDIGIT2
MODULES              := lab_readyDIGIT2_data.c lab_readyDIGIT2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := lab_readyDIGIT2.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := lab_readyDIGIT2_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/LabAuto;Z:/windows_profile/Desktop/LabAuto/lab_readyDIGIT2_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
