...
#ifndef RTW_HEADER_lab_readyDIGIT2_h_
#define RTW_HEADER_lab_readyDIGIT2_h_
#include <string.h>
#ifndef lab_readyDIGIT2_COMMON_INCLUDES_
#define lab_readyDIGIT2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab_readyDIGIT2_COMMON_INCLUDES_ */

#include "lab_readyDIGIT2_types.h"
...
#define lab_readyDIGIT2_rtModel        RT_MODEL_lab_readyDIGIT2_T
...
typedef struct {
  ...
  real_T DiscreteTransferFcn;          /* '<S2>/Discrete Transfer Fcn' */
  real_T degs2rpm;                     /* '<S2>/degs2rpm' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T AWUgain;                      /* '<S1>/AWU gain' */
  real_T Sum1_g;                       /* '<S1>/Sum1' */
...
typedef struct {
  ...
  real_T DiscreteTransferFcn_states[2];/* '<S2>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_j;               /* '<S1>/Delay' */
...
#define rtB                            lab_readyDIGIT2_B
#define BlockIO                        B_lab_readyDIGIT2_T
#define rtX                            lab_readyDIGIT2_X
#define ContinuousStates               X_lab_readyDIGIT2_T
#define rtXdot                         lab_readyDIGIT2_XDot
#define StateDerivatives               XDot_lab_readyDIGIT2_T
#define tXdis                          lab_readyDIGIT2_XDis
#define StateDisabled                  XDis_lab_readyDIGIT2_T
#define rtP                            lab_readyDIGIT2_P
#define Parameters                     P_lab_readyDIGIT2_T
#define rtDWork                        lab_readyDIGIT2_DW
#define D_Work                         DW_lab_readyDIGIT2_T

/* Parameters (default storage) */
struct P_lab_readyDIGIT2_T_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 250
                                        * Referenced by: '<Root>/Step'
                                        */
...
struct tag_RTM_lab_readyDIGIT2_T {
  const char_T *path;
...
extern P_lab_readyDIGIT2_T lab_readyDIGIT2_P;

/* Block signals (default storage) */
extern B_lab_readyDIGIT2_T lab_readyDIGIT2_B;

/* Continuous states (default storage) */
extern X_lab_readyDIGIT2_T lab_readyDIGIT2_X;

/* Block states (default storage) */
extern DW_lab_readyDIGIT2_T lab_readyDIGIT2_DW;

/* Model entry point functions */
extern void lab_readyDIGIT2_initialize(void);
extern void lab_readyDIGIT2_output(void);
extern void lab_readyDIGIT2_update(void);
extern void lab_readyDIGIT2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab_readyDIGIT2_rtModel *lab_readyDIGIT2(void);
...
extern RT_MODEL_lab_readyDIGIT2_T *const lab_readyDIGIT2_M;
 ...
 *
 * '<Root>' : 'lab_readyDIGIT2'
 * '<S1>'   : 'lab_readyDIGIT2/Discrete Speed Controller AWU'
 * '<S2>'   : 'lab_readyDIGIT2/Speed Filter1'
 */
#endif                                 /* RTW_HEADER_lab_readyDIGIT2_h_ */
