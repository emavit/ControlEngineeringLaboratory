...
#ifndef RTW_HEADER_lab_readyDIGIT3_h_
#define RTW_HEADER_lab_readyDIGIT3_h_
#include <string.h>
#ifndef lab_readyDIGIT3_COMMON_INCLUDES_
#define lab_readyDIGIT3_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab_readyDIGIT3_COMMON_INCLUDES_ */

#include "lab_readyDIGIT3_types.h"
...
#define lab_readyDIGIT3_rtModel        RT_MODEL_lab_readyDIGIT3_T
...
typedef struct {
  ...
  real_T DiscreteTransferFcn;          /* '<S5>/Discrete Transfer Fcn' */
  real_T degs2rpm;                     /* '<S5>/degs2rpm' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Saturation;                   /* '<S4>/Saturation' */
  real_T Output_p;                     /* '<S3>/Output' */
  real_T I;                            /* '<S4>/I' */
  real_T ia;                           /* '<Root>/Gain' */
  uint8_T FixPtSwitch;                 /* '<S8>/FixPt Switch' */
  uint8_T FixPtSwitch_d;               /* '<S11>/FixPt Switch' */
  uint8_T FixPtSwitch_f;               /* '<S14>/FixPt Switch' */
} B_lab_readyDIGIT3_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T Delay_DSTATE[10];             /* '<S5>/Delay' */
  real_T DiscreteTransferFcn_states[2];/* '<S5>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp;      /* '<S5>/Discrete Transfer Fcn' */
  ...
  uint8_T Output_DSTATE_n;             /* '<S9>/Output' */
  uint8_T Output_DSTATE_j;             /* '<S12>/Output' */
} DW_lab_readyDIGIT3_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
  real_T TransferFcn_CSTATE;           /* '<S5>/Transfer Fcn' */
  real_T TransferFcn1_CSTATE[2];       /* '<S5>/Transfer Fcn1' */
...
#define rtB                            lab_readyDIGIT3_B
#define BlockIO                        B_lab_readyDIGIT3_T
#define rtX                            lab_readyDIGIT3_X
#define ContinuousStates               X_lab_readyDIGIT3_T
#define rtXdot                         lab_readyDIGIT3_XDot
#define StateDerivatives               XDot_lab_readyDIGIT3_T
#define tXdis                          lab_readyDIGIT3_XDis
#define StateDisabled                  XDis_lab_readyDIGIT3_T
#define rtP                            lab_readyDIGIT3_P
#define Parameters                     P_lab_readyDIGIT3_T
#define rtDWork                        lab_readyDIGIT3_DW
#define D_Work                         DW_lab_readyDIGIT3_T

/* Parameters (default storage) */
struct P_lab_readyDIGIT3_T_ {
  ...
  real_T degs2rpm;                     /* Variable: degs2rpm
                                        ...
                                        */
  real_T denF[3];                      /* Variable: denF
                                        * Referenced by: '<S5>/Discrete Transfer Fcn'
                                        */
  real_T numF[3];                      /* Variable: numF
                                        * Referenced by: '<S5>/Discrete Transfer Fcn'
                                        */
  ...
  real_T AnalogOutput_MaxMissedTicks;
                                   ...
                                   * Referenced by: '<Root>/Analog Output'
                                   */
  real_T u_OutValues[2];               /* Mask Parameter: u_OutValues
                                        * Referenced by: '<S1>/Vector'
                                        */
  real_T u_OutValues_k[10];            /* Mask Parameter: u_OutValues_k
                                        * Referenced by: '<S2>/Vector'
                                        */
  real_T u_OutValues_e[2];             /* Mask Parameter: u_OutValues_e
  ...
  uint8_T LimitedCounter_uplimit_e;  /* Mask Parameter: LimitedCounter_uplimit_e
                                      ...
                                      */
  uint8_T LimitedCounter_uplimit_o;  /* Mask Parameter: LimitedCounter_uplimit_o
                                      * Referenced by: '<S14>/FixPt Switch'
                                      */
  real_T Gain_Gain;                    /* Expression: 1/(1e-2)
  ...
  real_T DiscreteTransferFcn_InitialStates;/* Expression: 0
                                            * Referenced by: '<S5>/Discrete Transfer Fcn'
                                            */
  real_T P_Gain;                       /* Expression: 0.056
                                        * Referenced by: '<S4>/P'
                                        */
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S4>/Saturation'
                                        */
  real_T I_Gain;                       /* Expression: 8.72
                                        * Referenced by: '<S4>/I'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 1/0.5
  ...
  uint8_T Output_InitialCondition;/* Computed Parameter: Output_InitialCondition
                                   ...
                                   */
  uint8_T Output_InitialCondition_m;
...
struct tag_RTM_lab_readyDIGIT3_T {
  const char_T *path;
...
extern P_lab_readyDIGIT3_T lab_readyDIGIT3_P;

/* Block signals (default storage) */
extern B_lab_readyDIGIT3_T lab_readyDIGIT3_B;

/* Continuous states (default storage) */
extern X_lab_readyDIGIT3_T lab_readyDIGIT3_X;

/* Block states (default storage) */
extern DW_lab_readyDIGIT3_T lab_readyDIGIT3_DW;

/* Model entry point functions */
extern void lab_readyDIGIT3_initialize(void);
extern void lab_readyDIGIT3_output(void);
extern void lab_readyDIGIT3_update(void);
extern void lab_readyDIGIT3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab_readyDIGIT3_rtModel *lab_readyDIGIT3(void);
...
extern RT_MODEL_lab_readyDIGIT3_T *const lab_readyDIGIT3_M;
 ...
 *
 * '<Root>' : 'lab_readyDIGIT3'
 * '<S1>'   : 'lab_readyDIGIT3/1'
 * '<S2>'   : 'lab_readyDIGIT3/2'
 * '<S3>'   : 'lab_readyDIGIT3/3'
 * '<S4>'   : 'lab_readyDIGIT3/Speed Controller'
 * '<S5>'   : 'lab_readyDIGIT3/Speed Filter1'
 * '<S6>'   : 'lab_readyDIGIT3/1/LimitedCounter'
 * '<S7>'   : 'lab_readyDIGIT3/1/LimitedCounter/Increment Real World'
 * '<S8>'   : 'lab_readyDIGIT3/1/LimitedCounter/Wrap To Zero'
 * '<S9>'   : 'lab_readyDIGIT3/2/LimitedCounter'
 * '<S10>'  : 'lab_readyDIGIT3/2/LimitedCounter/Increment Real World'
 * '<S11>'  : 'lab_readyDIGIT3/2/LimitedCounter/Wrap To Zero'
 * '<S12>'  : 'lab_readyDIGIT3/3/LimitedCounter'
 * '<S13>'  : 'lab_readyDIGIT3/3/LimitedCounter/Increment Real World'
 * '<S14>'  : 'lab_readyDIGIT3/3/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_lab_readyDIGIT3_h_ */
