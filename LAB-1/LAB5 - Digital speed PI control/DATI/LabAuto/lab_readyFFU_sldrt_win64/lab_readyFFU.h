...
#ifndef RTW_HEADER_lab_readyFFU_h_
#define RTW_HEADER_lab_readyFFU_h_
#include <string.h>
#ifndef lab_readyFFU_COMMON_INCLUDES_
#define lab_readyFFU_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* lab_readyFFU_COMMON_INCLUDES_ */

#include "lab_readyFFU_types.h"
...
#define lab_readyFFU_rtModel           RT_MODEL_lab_readyFFU_T

/* Block signals (default storage) */
typedef struct {
  real_T ia;                           /* '<Root>/Gain' */
  real_T Output;                       /* '<S4>/Output' */
...
typedef struct {
  real_T Delay_DSTATE[10];             /* '<S3>/Delay' */
...
typedef struct {
  ...
  real_T TransferFcn1_CSTATE[2];       /* '<S3>/Transfer Fcn1' */
...
typedef struct {
  ...
  boolean_T TransferFcn1_CSTATE[2];    /* '<S3>/Transfer Fcn1' */
...
#define rtB                            lab_readyFFU_B
#define BlockIO                        B_lab_readyFFU_T
#define rtX                            lab_readyFFU_X
#define ContinuousStates               X_lab_readyFFU_T
#define rtXdot                         lab_readyFFU_XDot
#define StateDerivatives               XDot_lab_readyFFU_T
#define tXdis                          lab_readyFFU_XDis
#define StateDisabled                  XDis_lab_readyFFU_T
#define rtP                            lab_readyFFU_P
#define Parameters                     P_lab_readyFFU_T
#define rtDWork                        lab_readyFFU_DW
#define D_Work                         DW_lab_readyFFU_T

/* Parameters (default storage) */
struct P_lab_readyFFU_T_ {
  struct_8LnTg2HasR61N4e63tMdJ sens;   /* Variable: sens
                                        ...
                                        *   '<S2>/Gain5'
                                        */
  struct_nnCjMXbWD7yQ89bIE3kkEH mot;   /* Variable: mot
                                        * Referenced by:
                                        *   '<S2>/Gain3'
                                        *   '<S2>/Gain4'
                                        *   '<S2>/Gain5'
  ...
  struct_vSWhg1oY4dvIzNJev85gsH drv;   /* Variable: drv
                                        ...
                                        *   '<S2>/Gain5'
                                        */
  real_T B_eq;                         /* Variable: B_eq
                                        * Referenced by: '<S2>/Gain7'
                                        */
  real_T J_eq;                         /* Variable: J_eq
  ...
  real_T AnalogOutput_MaxMissedTicks;
                                   ...
                                   * Referenced by: '<Root>/Analog Output'
                                   */
  real_T al_OutValues[6];              /* Mask Parameter: al_OutValues
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S2>/Saturation'
                                        */
  real_T AWUgain_Gain;                 /* Expression: 5/0.15
...
extern P_lab_readyFFU_T lab_readyFFU_P;

/* Block signals (default storage) */
extern B_lab_readyFFU_T lab_readyFFU_B;

/* Continuous states (default storage) */
extern X_lab_readyFFU_T lab_readyFFU_X;

/* Block states (default storage) */
extern DW_lab_readyFFU_T lab_readyFFU_DW;

/* Model entry point functions */
extern void lab_readyFFU_initialize(void);
extern void lab_readyFFU_output(void);
extern void lab_readyFFU_update(void);
extern void lab_readyFFU_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab_readyFFU_rtModel *lab_readyFFU(void);
...
extern RT_MODEL_lab_readyFFU_T *const lab_readyFFU_M;
 ...
 *
 * '<Root>' : 'lab_readyFFU'
 * '<S1>'   : 'lab_readyFFU/Ref Generator'
 * '<S2>'   : 'lab_readyFFU/Speed Controller AWU'
 * '<S3>'   : 'lab_readyFFU/Speed Filter'
 * '<S4>'   : 'lab_readyFFU/Ref Generator/al'
 * '<S5>'   : 'lab_readyFFU/Ref Generator/al/LimitedCounter'
 * '<S6>'   : 'lab_readyFFU/Ref Generator/al/LimitedCounter/Increment Real World'
 * '<S7>'   : 'lab_readyFFU/Ref Generator/al/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_lab_readyFFU_h_ */
